...
class HomeComponentState extends State<MyHomePage> {
  ...
  void tappedMenuButton(BuildContext context, String key) {
    ...
    if (key != "custom" && key != "function-call" && key != "fixed-trans") {
      if (key == "native") {
        ...
        hexCode = "#F700D2";
        message =
            "This screen should have appeared with a fade in transition 22";
      ...
      Application.router.navigateTo(
        context,
        "/demo?message=msg&color_hex=$hexCode&message=2&id=2",
